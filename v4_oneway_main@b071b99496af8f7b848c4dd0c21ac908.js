...
WrapperEntity.prototype.giftInfo = function() {
    ...
    switch (e) {
        ...
        case 1:
            switch (t) {
                case 11:
                    var r = (this.cPrice() + this.vPrice()) / 2;
                    n = '<p><font color="#CA8E38">1. 套餐包含<i class="rmb">&yen;</i>' + (r ? r : 20) + "接送机代金券2张，可使用联系人手机号码登录去哪儿客户端-车车-接送用车使用</font></p>" + "<p>2. 凭代金券享受接机或送机服务时可直接抵扣对应金额，限去哪儿专车供应商，优选型等指定车型使用，具体适用车型可在去哪儿客户端-个人中心-代金券中查看，每次服务仅限使用1张代金券；</p>" + "<p>3. 支持北京、上海等多个指定城市使用，具体适用城市可在去哪儿客户端-个人中心-代金券中查看；</p>" + "<p>4. 自购买机票之日起30天内可用，详细使用规则请登录去哪儿客户端-车车查看；</p>";
                    break;
                default:
                    n = '<p><font color="#CA8E38">1. 套餐包含<i class="rmb">&yen;</i>' + (this.cPrice() + this.vPrice()) + "接送机代金券" + (this.vAmount() || "1") + "张，可使用联系人手机号码登录去哪儿客户端-车车-接送用车使用</font></p>" + "<p>2. 凭代金券享受接机或送机服务时可直接抵扣对应金额，限去哪儿专车供应商，经济型、舒适型、商务型、豪华型等指定车型使用，具体适用车型可在去哪儿客户端-个人中心-代金券中查看，每次服务仅限使用1张代金券；</p>" + "<p>3. 支持北京、上海等多个指定城市使用，具体适用城市可在去哪儿客户端-个人中心-代金券中查看；</p>" + "<p>4. 自购买机票之日起30天内可用，详细使用规则请登录去哪儿客户端-车车查看；</p>";
                    break
            }
            return n;
        case 2:
...
OnewayFlightWrapperUI.prototype.insert_carPrice = function(e) {
    ...
    var s = e.carType();
    var o = e.afeePrice();
    this.text('<a class="v-ins p-tip-trigger" ', $jex.ie == 6 ? 'href="javascript:;"' : "", '><span class="v-ins-tit">+', i, '<i class="has-tip">');
    this.text("套餐</i>");
    this.text("</span>");
    this.text(this._getTipHTML(['套餐总价<font color="#ff6600"><i class="rmb">&yen;</i>', o + i, '</font><br>套餐含<i class="rmb">&yen;</i>', r + n, s, '<i class="plus">+</i><i class="rmb">&yen;</i>', t, "保险"].join(""), "js-packge-price-tip"));
    this.text("</a>");
    return i
};
...
(function(e) {
    ...
    var o = function() {
        ...
        e.prototype._getStaticUI = function() {
            var e = this.dataSource();
            this.text(['<div class="c0">', '<div class="a_logo">', '<img width="18" height="16" title="去哪儿网超值飞" alt="去哪儿网超值飞" src="http://simg1.qunarzz.com/site/images/flight/flight_search/qunar_icon.png">', "</div>", "</div>", '<div class="c1">', '<a class="a_name p-tip-trigger fuzzyflight-name" ' + (t ? 'href="javascript:;"' : "") + ">" + '<span class="name-tit">去哪儿网超值飞</span>' + '<div class="p-tips-cont"><div class="p-tips-wrap">' + '<div class="p-tips-arr p-tips-arr-t"><p class="arr-o">◆</p><p class="arr-i">◆</p></div>' + '<div class="p-tips-content">' + "<dl>" + "<dt>超值飞说明</dt>" + "<dd>您可根据起飞时间段选择购买超值飞产品，实际乘坐航班将在此时间段内起飞；</dd>" + "<dd>出票完成后第一时间将告知您具体航班号、起降时间及机场信息，请您放心购买</dd>" + "</dl>" + "</div>" + "</div></div>" + "</a>", "</div>", '<div class="c2-4">', '<div class="c-ref"></div>', '<div class="a_ex">绝对低价，保证出票</div>', "</div>", '<div class="c5">&nbsp;</div>'].join(""));
            this._insertPrice();
            this.text('<div class="c7">' + '<div class="c-ref"></div>' + '<div class="c-cont tags-info"><div class="a_pct clrfix"><i class="i_org_hot">最低</i>' + "</div></div>" + "</div>");
            this._insertOpenBtn()
        };
