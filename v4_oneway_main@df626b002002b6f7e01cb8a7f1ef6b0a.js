        ...
        case 1:
            switch (t) {
                case 11:
                    ...
                    n = '<p><font color="#CA8E38">1. 套餐包含<i class="rmb">&yen;</i>' + (r ? r : 20) + "接送机代金券2张，可使用联系人手机号码登录去哪儿客户端-车车-接送用车使用</font></p>" + "<p>2. 凭代金券享受接机或送机服务时可直接抵扣对应金额，限去哪儿专车供应商，优选型等指定车型使用，具体适用车型可在去哪儿客户端-个人中心-代金券中查看，每次服务仅限使用1张代金券；</p>" + "<p>3. 支持北京、上海等多个指定城市使用，具体适用城市可在去哪儿客户端-个人中心-代金券中查看；</p>" + "<p>4. 自购买机票之日起60天内可用，详细使用规则请登录去哪儿客户端-车车查看；</p>";
                    break;
                default:
                    n = '<p><font color="#CA8E38">1. 套餐包含<i class="rmb">&yen;</i>' + (this.cPrice() + this.vPrice()) + "接送机代金券" + (this.vAmount() || "1") + "张，可使用联系人手机号码登录去哪儿客户端-车车-接送用车使用</font></p>" + "<p>2. 凭代金券享受接机或送机服务时可直接抵扣对应金额，限去哪儿专车供应商，经济型、舒适型、商务型、豪华型等指定车型使用，具体适用车型可在去哪儿客户端-个人中心-代金券中查看，每次服务仅限使用1张代金券；</p>" + "<p>3. 支持北京、上海等多个指定城市使用，具体适用城市可在去哪儿客户端-个人中心-代金券中查看；</p>" + "<p>4. 自购买机票之日起60天内可用，详细使用规则请登录去哪儿客户端-车车查看；</p>";
                    break
            }
            return n;
        case 2:
...
OnewayFlightWrapperListUI.prototype._checkLowPriceOTA = function(e, t) {
    ...
    for (var o = 0; o < t.length; o++) {
        ...
        var f = e.commInfoMgr().get("vendor", u.wrapperId());
        if (!f) {
            s.push(u.wrapperId())
        }
    }
    if (!i) {
        var l = new Image;
        var c = "http://log.flight.qunar.com/l.gif?" + "s=flight&p=onewayList&r=lowPriceOTANotRender&flightCode=" + e.key();
        if (s.length > 0) {
            c += "&noVendorInfoID=" + s.join("|")
        }
        l.src = c
    }
};
