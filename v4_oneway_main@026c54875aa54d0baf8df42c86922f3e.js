...
WrapperEntity.prototype.isNewPrivilege = function() {
    return this.dataSource().type == "lpf" || this.dataSource().type == "tn" || this.dataSource().type == "nc" || this.dataSource().type == "tnlpf" || this.dataSource().type == "nclpf"
};
...
WrapperEntity.prototype.isAllDays = function() {
    if (this.dataSource().type && this.dataSource().type.toLowerCase() == "cpf" || this.dataSource().type == "lpf" || this.dataSource().type == "uff" || this.isOta() || this.isNewOta()) {
        return true
    }
    return false
};
...
WrapperEntity.prototype.hasPickCar = function() {
    var e = this.vType() == "5" || this.vType() == "7" || this.vType() == "8" || this.vType() == "9" || this.vType() == "10" || this.vType() == "11";
    return e
};
WrapperEntity.prototype.giftInfo = function() {
    ...
    switch (e) {
        ...
        case 1:
            switch (t) {
                case 11:
                    n = '<p><font color="#CA8E38">1. 套餐包含<i class="rmb">&yen;</i>' + (this.cPrice() ? this.cPrice() / 2 : 20) + "接送机代金券2张，可使用联系人手机号码登录去哪儿客户端-车车-接送用车使用</font></p>" + "<p>2. 凭代金券享受接机或送机服务时可直接抵扣对应金额，限去哪儿专车供应商，优选型等指定车型使用，具体适用车型可在去哪儿客户端-个人中心-代金券中查看，每次服务仅限使用1张代金券；</p>" + "<p>3. 支持北京、上海等多个指定城市使用，具体适用城市可在去哪儿客户端-个人中心-代金券中查看；</p>" + "<p>4. 自购买机票之日起30天内可用，详细使用规则请登录去哪儿客户端-车车查看；</p>";
                    break;
                default:
        ...
        case 2:
            switch (t) {
                case 9:
                    n = '<p class="tl">买保险赠超值礼包</p>' + '<p style="padding:3px 0 3px 3px"><strong>好礼一：</strong>去哪儿专车接送机代金券1张，直接抵扣<font color="#FF7301"><strong><i class="rmb"> &yen;</i>' + this.vPrice() + "</strong></font></p>" + '<p class="ft"><a target="_blank" href="http://flight.qunar.com/site/zhuanti/voucher_gift.htm?voucherType=9&voucherPrice=' + this.vPrice() + '">查看详情</a></p>';
                    break;
                case 10:
                    n = '<p class="tl">买保险赠超值礼包</p>' + '<p style="padding:3px 0"><strong>好礼一：</strong>去哪儿专车豪华接送机代金券1张，直接抵扣<font color="#FF7301"><strong><i class="rmb"> &yen;</i>' + this.vPrice() + "</strong></font></p>" + '<p class="ft"><a target="_blank" href="http://flight.qunar.com/site/zhuanti/voucher_gift.htm?voucherType=10&voucherPrice=' + this.vPrice() + '">查看详情</a></p>';
                    break;
                case 11:
                    n = '<p class="tl">买保险赠超值礼包</p>' + '<p style="padding:3px 0"><strong>好礼一：</strong>去哪儿专车接送机券礼包1份，总金额<font color="#FF7301"><strong><i class="rmb"> &yen;</i>' + this.vPrice() + "</strong></font>。</p>" + '<p class="ft"><a target="_blank" href="http://flight.qunar.com/site/zhuanti/voucher_gift.htm?voucherType=11&voucherPrice=' + this.vPrice() + '">查看详情</a></p>'
            }
            return n;
        default:
            return ""
...
WrapperEntity.prototype.isShowLijianIcon = function() {
    ...
    if (e && e.priceInfo() && e.priceInfo().hidelj == true) {
        return false
    }
    return true
};
...
OnewayFlightWrapperEntity.prototype.isFlyfundCanUse = function() {
    return this.dataSource().useffd === true || this.dataSource().useffd === "true"
};
OnewayFlightWrapperEntity.prototype.getFlyfundRefundNum = function() {
...
OnewayFlightWrapperUI.prototype.requestTgq = function(e, t) {
    ...
    var v = n.dataSource().tgqKey || 0;
    if ((s || l) && c && !(i && s)) {
        p = s ? p + s : p;
        d = s ? d + s : d;
        h = false
    }
    if ((n.isPriceKing() || n.isPgOta() || n.dataSource().type == "nclpf" || n.dataSource().type == "tnlpf") && n.tgqpr()) {
        p = n.tgqpr()
    }
    var m = this.find("tgq");
    var g = this.getDefaultTGQInfo(n);
    $jex.jsonp(o, {
...
OnewayFlightWrapperUI.prototype.insert_insureInfo = function(e) {
    ...
    } else if (n && r && this._type !== "YouFeiDaiOnewayFlightWrapperUI" && !(this._type == "PriceKingOnewayFlightWrapperUI" && t.getCarrierCo() == "cz")) {
...
OnewayFlightWrapperUI.prototype._bindHoverEvent = function(e) {
    ...
    this.onInit(function() {
        ...
        var l = t.labelIdList;
        l.length && $jex.foreach(l, function(e, r) {
        ...
        if (n.hasPickCar() && n.giftType() == 1 || n.hasHongbao()) {
            $jex.event.bind(e, "mousemove", function(t) {
                ...
                while (!$jex.hasClassName(n, "qvt-column") && n != document) {
                    ...
                    if ($jex.hasClassName(n, "p-tip-trigger") || $jex.hasClassName(n, "e_qstar") || $jex.hasClassName(n, "v-tgq") || $jex.hasClassName(n, "v-gift")) {
