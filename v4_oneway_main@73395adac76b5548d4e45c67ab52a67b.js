...
var oneway_config = {
    ...
    PakageConfig: ["cpf", "btf", "lpf", "uff", "lcf", "laf", "fpc", "pec", "fcc", "bcc", "bpf", "tnlpf"],
    OnewayListLabels: {
        preferences: {
            text: "已减",
            color: "red",
...
FlightUI.prototype._getStopHtmlInfo = function(e) {
    var t = e,
        n = t.stopover() && t.stops() == 1 && t.spCity(),
        r = {};
    if (n) {
        var i = t.spCity();
        r.tit = '<div class="ifo"><i class="z">停</i>' + i + "</div>";
        r.cont = "" + "<p>经停城市：" + i + "</p>" + "<p>经停机场：" + t.spAirPort() + "</p>"
    }
    return r
};
...
OnewayFlightUI.prototype._getStaticUI = function(e) {
    ...
    t.push("</div>");
    t.push('<div class="c3">');
    var r = n.stopover() && n.stops() == 1 && n.spCity();
    if (r) {
...
FlagshipOnewayFlightWrapperUI.prototype.getLabels = function(e) {
    ...
    if (t.isSHFDRProduct()) {
        var u = i["FeiDaRen"];
        u.content = this._getTipHTML("<span>一年内购票满十次即享直减优惠！</span>");
        s.push(u)
    }
    return r.concat(s)
};
