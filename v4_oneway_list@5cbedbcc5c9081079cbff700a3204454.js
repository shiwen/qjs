...
function _sortByTypeAndPrice(e, t, n) {
    for (var r = 0; r < e.length - 1; r++) {
        for (var i = 0; i < e.length - 1 - r; i++) {
            var s = e[i];
            var o = e[i + 1];
            if (t[s].deptTimeValue() !== t[o].deptTimeValue()) {
                continue
            }
            ...
            var c = 0;
            var h = 0;
            var p = _getsortPrice(s, t);
            var d = _getsortPrice(o, t);
            if (p > d) {
                h += f
            }
            if (p < d) {
...
$jex.exec(function() {
    ...
    FlightListUISorter.divideSort = function(e, t, n) {
        ...
        if (n[0][0] == "lowestPrice") {
            var u = n[0][1];
            r.sort(function(e, n) {
                return u ? _getsortPrice(n, t) - _getsortPrice(e, t) : _getsortPrice(e, t) - _getsortPrice(n, t)
            });
            _sortByTypeAndTime(r, t, true)
        } else {
            _sortByTypeAndPrice(r, t, true)
        }
        e.splice(0, e.length);
