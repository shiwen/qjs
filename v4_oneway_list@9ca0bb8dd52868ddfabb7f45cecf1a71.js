...
var DomesticOnewayDataAnalyzer = new function() {
    ...
    function O(t) {
        ...
        if (!t || !t.priceData || a === 0) {
            var f = new Image;
            f.src = "http://log.flight.qunar.com/l.gif?s=flight&p=onewayList&r=groupInfoError&info=" + encodeURIComponent(n) + "&msg=nullWrapper"
        }
...
var DomesticOnewaySearchService = new function() {
    ...
    this._invoke_flightPriceData = function(r, i, s) {
        ...
        var v = setTimeout(function() {
            if (d) {
                var e = new Image;
                e.src = "http://log.flight.qunar.com/l.gif?s=flight&p=onewayList&r=groupInfoError&info=" + encodeURIComponent(r) + "&msg=timeout"
            }
        }, 1e4);
...
TransferFlightUI.prototype._insertColums = function(e, t) {
    ...
    if (t && n.deptDate() != e.firstTrip().arriDate()) {
        this.text('<div title="出发达时间为第2天&nbsp;', n.deptDate(), '" class="a_tm_dep">次日', n.deptTime(), "</div>")
    } else {
...
(function() {
    ...
    var d = function() {
        ...
        setTimeout(function() {
            ...
            n.src = "http://simg1.qunarzz.com/site/images/flight/flight_search/hotel_hongbao.jpg";
            n.onload = function() {
                r.appendChild(n);
