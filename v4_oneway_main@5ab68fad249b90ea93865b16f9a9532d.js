...
WrapperEntity.prototype.isAllDays = function() {
    if (this.dataSource().type == "CPF" || this.dataSource().type == "lpf" || this.dataSource().type == "uff" || this.isOta() || this.isNewOta()) {
        return true
    }
    return false
};
...
OnewayFlightWrapperUI.prototype.createPriceLabelUI = function(e, t) {
    ...
    } else if (n.hasPickCar() && n.giftType() == 2) {
...
OnewayFlightWrapperUI.prototype.insert_insureInfo = function(e) {
    ...
    } else if (n && r && this._type !== "PriceKingOnewayFlightWrapperUI" && this._type !== "YouFeiDaiOnewayFlightWrapperUI") {
...
YouFeiDaiOnewayFlightWrapperUI.prototype.getPriceLabels = function(e) {
    ...
    if (s) {
        ...
        o.text = '<span class="icon-head">现付</span><i class="rmb">&yen;</i>' + (u - s);
        o.content = this._getTipHTML(['总价<i class="rmb">&yen;</i>', u, '，现在仅需支付<font color="#FF7103"><i class="rmb">&yen;</i>', u - s, '</font><br>贷款<i class="rmb">&yen;</i>', s, "，支付成功后六个月内<br>返还去哪儿网即可。"].join(""));
        o && r.push(o)
    }
    return n.concat(r)
};
