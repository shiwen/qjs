...
OnewayFlightWrapperUI.prototype.insert_insureInfo = function(e) {
    ...
    } else if (t.hasPickCar() && t.giftType() == 1 && t.isShowAfee()) {
...
(function(e) {
    ...
    function s(e) {
        ...
        var t = new Date(Date.parse("2015/08/17 " + e));
        var n = new Date(t.getTime() - 1 * 60 * 1e3);
        var r = $jex.date.format(n, "yyyy-MM-dd HH:mm:ss").split(" ")[1];
        var i = r.split(":");
        return i[0] + ":" + i[1]
    }
    ...
    $jex.extendClass(o, OnewayFlightWrapperUI);
    ...
    o.prototype.insert_vendorInfo = function(e) {
        var t = e;
        var r = t.dataSource();
        var i = r.periodDesc;
        var o = r.timeRange.split("-");
        this.timeRange = o[0] + " - " + s(o[1]);
    ...
    o.prototype.getLabels = function(e) {
        var t = [];
    ...
    o.prototype._buttonHTML = function(e, t, n) {
        var r = "";
        var i = this.bookingScreenUI;
        var s = e === "bpr" ? t.bpackagePrice() : t.packagePrice();
        var o = "btn-book-org";
    ...
    o.prototype.bindBookingEvent = function(e) {
        this.onInit(function() {
    ...
    o.prototype.getDeptTimeRangeValue = function() {
    ...
    $jex.extendClass(u, XControl);
    u.prototype.ownerFuzzyFlightUI = function(e) {
        if (arguments.length) {
    ...
    u.prototype.updateEntity = function(e) {
        var t = this;
        if (e) {
            this.clear();
            t._cachelist = [];
    ...
    var a = function() {
        ...
        e.prototype._getStaticUI = function() {
            ...
            this.text('<div class="c6">' + '<div class="c-ref"></div>' + '<div class="c-cont" id="js-fuzzy-price">' + this._getPriceHtml() + "</div></div>");
            this.text('<div class="c7">&nbsp;</div>');
            this._insertOpenBtn()
        };
        e.prototype._getPriceHtml = function(e) {
            var t = this.dataSource();
            var n = e || t.lowpr;
            var r = t.op;
            var i;
            var s = [];
            if (n && n != 1e5) {
                s.push('<div class="a_low_prc">' + Price_html.getHTML(n) + '<i class="rmb">¥</i></div>');
                if (r) {
                    i = Math.round(n / t.op * 100) / 10;
                    s.push('<div class="a_low_dsc">' + PriceUtil.getOneWayDiscount(i) + "</div>")
                }
            } else {
                s.push('<div class="nopr"><div>暂无报价</div></div>')
            }
            return s.join("")
        };
        e.prototype.refreshPrice = function(e) {
            if (e) {
                $jex.$("js-fuzzy-price").innerHTML = this._getPriceHtml(e)
            }
        };
        ...
        e.prototype.updateVendors = function() {
            ...
            this.text('<div class="b-qvt-lst">');
            this.text('<div id="js-wrapper-list' + t + '" class="e-qvt-ct" style="*zoom: 1;*position: relative;*z-index: 3;">');
            this.text("</div>");
            this.text('<div class="qvt_col_hide"><a class="lnk_more lnk_more_hd" href="##"  id="js-hide-list' + t + '">隐藏报价<i class="ico_down"></i></a>' + '<span class="qvt_ex"><i class="ico_tip"></i>具体航班和起降时间将在出票完成后，第一时间短信通知您，请放心购买。</span>' + "</div>");
            this.text("</div>");
            this.append("<div", "extAd_panel", ' class="extAD"></div>');
            this.text("</div>");
            this.onInit(function() {
