...
OtaOnewayFlightWrapperUI.prototype.insert_vendorInfo = function(e) {
    ...
    this.text(['<div class="v0">', '<a class="v-type-icon ', t, ' p-tip-trigger" ', $jex.ie == 6 ? 'href="javascript:;"' : "", ">", '<span class="ico">商旅优选</span>', this.getOtaTips(e), "</a></div>"].join(""))
};
...
OtaOnewayFlightWrapperUI.prototype.getOtaTips = function(e) {
    ...
    this._otaTips = this._getTipHTML(["<p>出票迅速：支付后极速出票</p>", e.isNewOta() ? "" : "<p>报销无忧：起飞后可邮寄行程单</p>", "<p>服务优先：7*24小时全天候服务</p>"].join(""), "js-wrapper-logo-tip");
    return this._otaTips
};
