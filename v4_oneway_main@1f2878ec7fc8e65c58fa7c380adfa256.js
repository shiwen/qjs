...
WrapperEntity.prototype.booking = function(e, t, n) {
    var r = this;
    LockScreen(function() {
        OnewayFlightWrapperEntity.prototype._booking;
        r._booking(e, t, n);
        r.adsTrack()
    })
};
...
WrapperEntity.prototype.wapSaleInfo = function() {
    var e = this._valCache["wapSaleInfo"];
    if (typeof e == "undefined" || e == null) {
        var t = this.dataSource();
        e = {
            wapBu: t.wapBu,
            dvs: t.dvs || 0,
            wapDomain: t.wapDomain || ""
        };
        this._valCache["wapSaleInfo"] = e
    }
    return e
};
WrapperEntity.prototype.logBooking = function(e) {
    try {
        var t = this;
        var n = t;
        var r = t.ownerFlight();
        ...
        var u = r.arriCity().zh;
        var a = r.deptDate();
        var f = (new Date).getTime() - ($jex.logHelp.lastOpenWrapperTime || window.CLIENT_TIME.getTime());
        var l = $jex.logHelp.openWrapperCount || 1;
        var c = false;
        if (r._shareFlight) {
            c = true
        }
        if (f < 3e3 || f > 60 * 60 * 1e3) {
            return
        }
        var h = {
            s: "flight",
...
OnewayFlightWrapperEntity.prototype._openBookingUrl = function(e, t, n) {
    ...
    this._booking_track();
    TsinghuaOneWayTracker.trackLowPrChange(s, 1)
};
OnewayFlightWrapperEntity.prototype._booking = function(e, t, n) {
    t = t || {};
    if (!t.BookingLocation) {
        if (this.isRoundFlight()) {
            t.BookingLocation = "oneWayList"
        } else {
            var r = this.ownerFlight().getWrapperListType() || "all";
            t.BookingLocation = "list_" + r
        }
    }
    this._openBookingUrl(e, t, n);
...
WrapperUI.prototype.jumpToBooking = function(e, t, n) {
    ...
    var i = {
        uiType: (this._type || "").replace("FlightWrapperUI", "")
    };
    e.booking(this.stat, r, i)
};
...
VendorListUI.prototype.createHongbaoHtml = function(e) {
    VendorListUI.loadHongbaoHtml(function(t) {
        t && (e.innerHTML = t)
    })
};
VendorListUI.loadHongbaoHtml = function(e) {
    var t = "http://quan.qunar.com/bonus/social/getSwitchConfig?from=flightwww";
    var n = [];
    if (VendorListUI._loadedHongBao) {
        e(VendorListUI._hongBaoHtml);
        return
    }
    VendorListUI._loadedHongBao = true;
    $jex.jsonp(t, {}, function(t) {
        var r = t.data;
        if (!t.status && r && r.open && r.price) {
            n.push("<a target='_blank' href='" + r.url + "?sourceID=flight_search" + "'><div class='hongbao'>");
            n.push("<div class='hongbaoicon'></div>");
            n.push("<div class='hongbaotext'>" + r.text + "<span><i>&yen;</i>" + r.price + "<em>！</em></span></div>");
            n.push("<div class='hongbaobtn'><span>领红包</span></div>");
            n.push("</div></a>")
        }
        VendorListUI._hongBaoHtml = n.join("");
        e(VendorListUI._hongBaoHtml)
    }, function() {
        VendorListUI._hongBaoHtml = "";
        e(VendorListUI._hongBaoHtml)
    })
};
...
OnewayFlightWrapperUI.prototype.getGuideAppInfo = function(e, t, n) {
    var r = this;
    var i = n;
    var s = document.getElementById(e.labelId);
    var o = t.find("guideAppPanel");
    var u = t.find("guideAppContent");
    var a = i.wapSaleInfo();
    var f;
    if (s) {
        var l = false;
        ...
        function h() {
            var e = "http://rabbit.qunar.com/QRCode";
            $jex.jsonp(e, {
                bu: a.wapBu,
                cabin: i.cabin(),
                domain: a.wapDomain
        ...
        function p(e) {
            ...
            if (t === 0 && e.pictureUrl) {
                ...
                var d = p + (i.cPrice() || 0);
                var v = "";
                if (i.hasPickCar() && i.giftType() == 1 && i.isShowAfee()) {
                    v = "+" + d + "套餐"
                } else if (i.isShowAfee() && s && p && this._type !== "YouFeiDaiOnewayFlightWrapperUI") {
                    v = "+" + p + "保险"
                }
                innerText = '<div class="guide clrfix">' + '<img class="guide-img" width="100" height="100" src="' + r + '"/>' + '<div class="guide-txt">' + '<p class="tit"><span class="m">扫一扫，手机下单立减</span><span class="red"><i class="rmb">&yen;</i>' + n + "</span></p>" + '<p class="ct">使用去哪儿APP扫码下单，购买手机专享产品，可享立减优惠。</p>' + '<p class="ft">手机专享价：<span class="del"><i class="rmb">&yen;</i>' + f + '</span><span class="red"><i class="rmb">&yen;</i>' + h + "</span>" + v + "</p>" + "</div></div>"
            } else {
                innerText = "请求失败，稍后再试"
            }
            u.innerHTML = innerText;
            !c && $jex.element.show(o)
        }
    }
};
...
OnewayFlightWrapperUI.prototype.getPriceLabels = function(e) {
    ...
    if (l.wapBu && l.dvs) {
        i = s["guideApp"];
        i.content = this._getTipHTML('<img class="p-tips-tgq-img" src="http://simg1.qunarzz.com/site/images/new_main/m_loading.gif" />', "guideAppPanel", "guideAppContent");
        i.needAjax = true;
        r.push(i)
    }
    return r
        ...
        if (n.hasPickCar() && n.giftType() == 1 || n.hasHongbao()) {
            $jex.event.bind(e, "mousemove", function(t) {
                ...
                while (!$jex.hasClassName(n, "qvt-column") && n != document) {
                    ...
                    if ($jex.hasClassName(n, "p-tip-trigger") || $jex.hasClassName(n, "e_qstar") || $jex.hasClassName(n, "v-tgq") || $jex.hasClassName(n, "v-gift") || $jex.hasClassName(n, "v-tag-pickcar") || $jex.hasClassName(n, "v-tag-wap")) {
...
YouFeiOnewayFlightWrapperUI.prototype.getFakeYoufeiLabel = function(e) {
    ...
    if (n > 0) {
        var r = ConfigManager.getConfig("OnewayListLabels");
        t = r["fakeYoufei"];
        t.text = '已省<i class="rmb">&yen;</i>' + n;
        t.content = this._getTipHTML("送" + n + '个优飞币，立抵<i class="rmb">&yen;</i>' + n)
    }
    return t
};
    ...
    var u = function() {
        ...
        e.prototype.loadData = function(e) {
            try {
                ...
                this.trackLoad();
                this._bindEvent();
                this.blackFirm = (this.data || {}).blackFirm;
        ...
        e.prototype.filterByFirm = function() {
            var e = (window.System.analyzer.getDataSet().getFiltersMap("航空公司") || {}).value;
            var t = this.blackFirm;
            var n = false;
            if (!e || !e.length || !t || !t.length) {
                n = true
            } else {
                $jex.array.each(e, function(e) {
                    if ($jex.array.indexOf(t, e) == -1) {
                        n = true;
                        return $jex.$break
                    }
                })
...
(function(e) {
    ...
    e.extend(M.prototype, {
        ...
        draw: function(t) {
            ...
            r.loadMonthStore.push(t.getMonth(), t.getMonth() + 1 == 12 ? 0 : t.getMonth() + 1)
        },
        dispose: function() {
